...
if ( !class_exists( 'ReduxFramework_kad_slides' ) ) {
	...
	class ReduxFramework_kad_slides
	{
		...
		public function render()
		{
			...
			$defaults = array( 'show' => array( 'title' => true, 'description' => true, 'url' => true, ), 'content_title' => __( 'Slide', 'pinnacle' ) );
			...
			if ( isset ( $this->value ) && is_array( $this->value ) && !empty ( $this->value ) ) {
				...
				foreach ( $slides as $slide ) {
					...
					$defaults = array( 'title' => '', 'description' => '', 'sort' => '', 'link' => '', 'image' => '', 'target' => '', 'url' => '', 'thumb' => '', 'attachment_id' => '', 'height' => '', 'width' => '', 'select' => array(), );
		...
		public function enqueue()
		{
			...
			wp_enqueue_script( 'kad-field-slides-js', get_template_directory_uri() . '/themeoptions/options_assets/extensions/kad_slides/kad_slides/field_kad_slides' . Redux_Functions::isMin() . '.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-accordion', 'wp-color-picker' ), time(), true );

			wp_enqueue_style( 'kad-field-slides-css', get_template_directory_uri() . '/themeoptions/options_assets/extensions/kad_slides/kad_slides/field_kad_slides.css', time(), true );
		}
