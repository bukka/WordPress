...
if ( !class_exists( 'ReduxFramework_kad_icons' ) ) {
	...
	class ReduxFramework_kad_icons
	{
		...
		{
			$defaults = array( 'show' => array( 'title' => true, 'description' => true, 'url' => true, ), 'content_title' => __( 'Icon', 'pinnacle' ) );
			...
			if ( isset( $this->value ) && is_array( $this->value ) ) {
				...
				foreach ( $slides as $slide ) {
					...
					$defaults = array( 'icon_o' => '', 'title' => '', 'description' => '', 'sort' => '', 'target' => '', 'link' => '', 'url' => '', 'thumb' => '', 'image' => '', 'attachment_id' => '', 'height' => '', 'width' => '', 'select' => array(), );
					...
					$hide = '';
					if ( empty( $slide['url'] ) || $slide['url'] == '' ) $hide = ' hide';
		...
		public function enqueue()
		{
			...
			wp_enqueue_script( 'redux-field-media-js', ReduxFramework::$_url . 'inc/fields/media/field_media' . Redux_Functions::isMin() . '.js', array( 'jquery' ), time(), true );

			wp_enqueue_style( 'redux-field-media-css', ReduxFramework::$_url . 'inc/fields/media/field_media.css', time(), true );

			wp_enqueue_script( 'kad-field-icons-js', get_template_directory_uri() . '/themeoptions/options_assets/extensions/kad_icons/kad_icons/field_kad_icons' . Redux_Functions::isMin() . '.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-accordion', 'wp-color-picker' ), time(), true );

			wp_enqueue_style( 'kad-field-icons-css', get_template_directory_uri() . '/themeoptions/options_assets/extensions/kad_icons/kad_icons/field_kad_icons.css', time(), true );
		}
