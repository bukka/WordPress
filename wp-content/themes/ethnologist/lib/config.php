...
if ( isset( $pinnacle['post_word_count'] ) ) {
    $excerptlength = $pinnacle['post_word_count'];
} else {
    $excerptlength = '40';
}
...
function kadence_shop_layout_css() {
    ...
    if ( kadence_display_sidebar() ) {
        ...
        if ( isset( $pinnacle['product_shop_layout'] ) ) {
            $columns = "shopcolumn" . $pinnacle['product_shop_layout'] . " shopfullwidth";
        } else {
