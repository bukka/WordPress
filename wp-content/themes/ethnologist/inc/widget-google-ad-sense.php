...
class Ethnologist_Widget_GoogleAdSense extends WP_Widget {
	...
	public function __construct() {
		...
		$this->alt_option_name = 'ethnologist_widget_google_adsense';
	...
	public function widget( $args, $instance ) {
		$cache = wp_cache_get( 'ethnologist_widget_google_adsense', 'widget' );
		...
		ethnologist_view( 'widget', 'google-adsense-widget', $instance );

		echo $after_widget;

		$cache[$args['widget_id']] = ob_get_flush();
		wp_cache_set( 'ethnologist_widget_google_adsense', $cache, 'widget' );
	}
	...
	function flush_widget_cache() {
		wp_cache_delete( 'ethnologist_widget_google_adsense', 'widget' );
	}
	...
	function form( $instance ) {
		...
		ethnologist_view( 'widget', 'google-adsense-form', $params, $this );
	}
}
