...
function gmediacloud_social_sharing()
{
    ...
    <style>
        ...
        .share-btn,
        .share-btn:visited { display:inline-block; color:#ffffff; border:none; padding:2px 7px; min-width:2.1em; opacity:0.9; box-shadow:0 2px 0 0 rgba(0, 0, 0, 0.2); outline:none; text-align:center; box-sizing:border-box; text-decoration:none; }
        .share-btn:hover { color:#eeeeee; text-decoration:none; }
