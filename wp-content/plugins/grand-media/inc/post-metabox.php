                    ...
                    <div class="media-frame wp-core-ui hide-router hide-toolbar">
                        ...
                        <div class="media-frame-menu">
                            <div class="media-menu">
                                <a id="gmedia-modal-terms" class="media-menu-item active" target="gmedia_frame" href="<?php echo add_query_arg(array('post_id'    => $post->ID,
                                                                                                                                                     'tab'        => 'gmedia_terms',
                                                                                                                                                     'chromeless' => true
                                ...
                                <a id="gmedia-modal-galleries" class="media-menu-item" target="gmedia_frame" href="<?php echo add_query_arg(array('post_id'    => $post->ID,
...
function gmedia_related_post_metabox($post){
    ...
    <div id="gmedia-wraper">
        ...
        <div class="form-group">
            ...
            <input type="text" name="_related_gmedia_per_page" value="<?php echo $related_per_page; ?>" placeholder="<?php _e('Leave empty for no limit', 'grand-media'); ?>" class="form-control input-sm"/>
        </div>
    </div>
    <?php
}
